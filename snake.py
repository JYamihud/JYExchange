...
def snake_graphics(widget, event):
    ...
    if pixelsize > 2:
        ...
        xgc.set_rgb_fg_color(gtk.gdk.color_parse("#BBBBBB"))
    ...
    # death
    dead = False
    if (snake[0][0],snake[0][1]) in snake[1:] or snake[0][0] == w/pixelsize-1 or snake[0][1] == h/pixelsize-1\
...
graphics.connect("expose-event", snake_graphics)
